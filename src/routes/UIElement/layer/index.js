...
const IcoPage = () => {
	const handleButtonClick = (key) => {
		if (key === Enum.default) {
			layer.open({
				title: '默认弹层', content: <div style={{height: 360}}>弹层内容</div>
			})
		}
	}
	return (
		<div className="content-inner">
			...
			<div style={{margin: '16px 0'}}>
				...
				config对象与
				<a href="https://ant.design/components/modal-cn/#API" target="_blank">Modal</a>
				的参数基本一致，config属性如下。 注意：1.visible属性一般不需要设置；2.afterClose无效，layer.close()可代替;3.layer.open()返回一个唯一的layer Id
			</div>
			<Row>
				<Col lg={18} md={24}>
